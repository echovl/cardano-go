...
func TestCertificateEncoding(t *testing.T) {
	// 82008200581cd4ffa2b8832507dd670bccff5ec67901737af9dfb2a277d1cf13302b
	// 82018200581cd4ffa2b8832507dd670bccff5ec67901737af9dfb2a277d1cf13302b
	// 83028200581cd4ffa2b8832507dd670bccff5ec67901737af9dfb2a277d1cf13302b581c20df8645abddf09403ba2656cda7da2cd163973a5e439c6e43dcbea9
	// 
	// 8304581c20df8645abddf09403ba2656cda7da2cd163973a5e439c6e43dcbea919012c
	// 8405581c20df8645abddf09403ba2656cda7da2cd163973a5e439c6e43dcbea9581c20df8645abddf09403ba2656cda7da2cd163973a5e439c6e43dcbea9582020df8645abddf09420df8645abddf09420df8645abddf09420df8645abddf094
	...
	// 	},
	// }
	// stakeDeregIn := stakeDeregistration{
	// 	Type: StakeDeregistration,
	// 	StakeCredential: StakeCredential{
	// 		Type: AddrKeyCredential,
	// 		AddrKeyHash: AddrKeyHash{
	...
	// genesisKeyDelIn := genesisKeyDelegation{
	// 	Type: GenesisKeyDelegation,
	// 	GenesisHash: Hash28{
	// 		0x20, 0xdf, 0x86, 0x45, 0xab, 0xdd, 0xf0, 0x94, 0x3, 0xba, 0x26, 0x56, 0xcd, 0xa7,
	// 		0xda, 0x2c, 0xd1, 0x63, 0x97, 0x3a, 0x5e, 0x43, 0x9c, 0x6e, 0x43, 0xdc, 0xbe, 0xa9,
	...
	// stakeRegOut, _ := cbor.Marshal(stakeRegIn)
	// stakeDeregOut, _ := cbor.Marshal(stakeDeregIn)
	// stakeDelOut, _ := cbor.Marshal(stakeDelIn)
	// poolRegOut, _ := cbor.Marshal(poolRegIn)
	// poolRetOut, _ := cbor.Marshal(poolRetIn)
	// genesisKeyDelOut, _ := cbor.Marshal(genesisKeyDelIn)

	// fmt.Println(hex.EncodeToString(stakeRegOut))
	// fmt.Println(hex.EncodeToString(stakeDeregOut))
	// fmt.Println(hex.EncodeToString(stakeDelOut))
	// fmt.Println(hex.EncodeToString(poolRegOut))
	// fmt.Println(hex.EncodeToString(poolRetOut))
	// fmt.Println(hex.EncodeToString(genesisKeyDelOut))
