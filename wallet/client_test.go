...
type TestVector struct {
	...
	addrXsk1               string
	addrXvk1               string
	paymentBaseAddr0       string
	paymentEnterpriseAddr0 string
	paymentEnterpriseAddr1 string
	stakeAddr              string
}
...
var testVectors = []TestVector{
	// 15 words
	{
		...
		paymentEnterpriseAddr0: "addr_test1vpu5vlrf4xkxv2qpwngf6cjhtw542ayty80v8dyr49rf5eg57c2qv",
		paymentEnterpriseAddr1: "addr_test1vq0a2lgc2e0r597dr983jrf5ns4hxz027u8n7wlcsjcw4ks96yjys",
	...
	// 18 words
	{
		...
		paymentEnterpriseAddr0: "addr_test1vptvyjfjvs7wdn583rv3th3fvf9fauv5f6gylkhh5k245zcdjvdac",
		paymentEnterpriseAddr1: "addr_test1vr3nq3kyg9c9t4nn6a5zymz3at3zsmcr9lkqxghxh5v822gcu7ava",
	...
	// 21 words
	{
		...
		paymentEnterpriseAddr1: "addr_test1vzr08acccp7s3l9cppvptz7jyflejkkuma2k06vx4vjrcqsl4gkk5",
...
func TestCreateWallet(t *testing.T) {
	for _, testVector := range testVectors {
		...
		baseAddresses, err := w.BaseAddresses()
		if err != nil {
			t.Fatal(err)
		}
		if baseAddresses[0].Bech32() != testVector.paymentBaseAddr0 {
			t.Errorf("invalid paymentBaseAddr0:\ngot: %v\nwant: %v", baseAddresses[0], testVector.paymentBaseAddr0)
		}

		enterpriseAddresses, err := w.EnterpriseAddresses()
		if err != nil {
			t.Fatal(err)
		}
		if enterpriseAddresses[0].Bech32() != testVector.paymentEnterpriseAddr0 {
			t.Errorf("invalid paymentEnterpriseAddr0:\ngot: %v\nwant: %v", enterpriseAddresses[0], testVector.paymentEnterpriseAddr0)
		}
...
func TestRestoreWallet(t *testing.T) {
	for _, testVector := range testVectors {
		...
		if addresses[0].Bech32() != testVector.paymentEnterpriseAddr0 {
			t.Errorf("invalid paymentEnterpriseAddr0:\ngot: %v\nwant: %v", addresses[0], testVector.paymentEnterpriseAddr0)
		}
